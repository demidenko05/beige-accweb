...
<button class="btn" onClick="bsSelEnt('${ent.iid}',&quot;${ent.nme}&quot;,'${lsPlNm}${param.ent}');bsSetUom('${ent.duom.iid}',&quot;${ent.duom.nme}&quot;,'${lsPlNm}${param.ent}');bsSetCost(${ent.knCs},'${lsPlNm}${param.ent}');${tcf}">${i18n.getMsg("Pick", rvs.upf.lng.iid)}</button>
