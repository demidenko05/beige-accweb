...
<tr>
  ...
  <td>
    <div class="input-line">
      ...
      <input id="${cls.simpleName}${fdNm}Id" type="hidden" name="${cls.simpleName}.${fdNm}" value="${ent[fdNm].iid}">
      <button ${auFoc} type="button" class="btn" onclick="bsPick('Acnt','${cls.simpleName}','${fdNm}','&fopusedVl=true&fopblTyVl=0&fopblTyOpr=eq&fopfrcd=used,blTy&mbl=${param.mbl}');">...</button>
