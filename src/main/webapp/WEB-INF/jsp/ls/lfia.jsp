...
<c:if test="${empty param.mbl}">
  <div class="pages">
    ...
    <button id="listMainNew" onclick="bsGtAjx('GET', 'srv/?rnd=eiaj&act=entCr&ent=${cls.simpleName}&pg=${param.pg}${flyPar}');" class="btn">
...
<c:if test="${not empty param.mbl}">
  <div class="pages">
    ...
    <button onclick="bsGtAjx('GET', 'srv/?rnd=eiaj&act=entCr&ent=${cls.simpleName}&pg=${param.pg}${flyPar}');" class="btn">
      ${i18n.getMsg('New', rvs.upf.lng.iid)}
    </button>
  </div>
</c:if>
