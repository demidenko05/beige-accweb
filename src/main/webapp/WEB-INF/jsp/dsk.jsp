  ...
  <div class="navbar">
    <div class="dropdown">
      ...
      <div class="dropdown-content">
        ...
        <a href="#" onclick="bsGtAjx('GET', 'srv?act=lst&rnd=lhj&ent=Prop&pg=1');">${i18n.getMsg("Props", rvs.upf.lng.iid)}</a>
    ...
    <div class="dropdown">
      ...
      <div class="dropdown-content">
        ...
        <a href="#" onclick="bsGtAjx('GET', 'srv?act=lst&rnd=lhj&ent=BnkStm&pg=1');">${i18n.getMsg("BnkStms", rvs.upf.lng.iid)}</a>
        ...
        <a href="#" onclick="bsGtAjx('GET', 'srv?act=lst&rnd=lhj&ent=BnkCsv&pg=1');">${i18n.getMsg("BnkCsvs", rvs.upf.lng.iid)}</a>
      </div>
    </div>
    <div class="dropdown">
