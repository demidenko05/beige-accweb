...
<div class="row">
  ...
  <div class="col-12 col-md-4 mb-3">
    ...
    <input id="fltPriVal1" name="fltPriVal1" ${disbV1} type="text" class="form-control bsNum0" value="${rvs.fltPri.val1}">
  </div>
  <div class="col-12 col-md-4 mb-3">
    ...
    <input id="fltPriVal2" name="fltPriVal2" ${disbV2} type="text" class="form-control bsNum0" value="${rvs.fltPri.val2}">
  </div>
</div>
