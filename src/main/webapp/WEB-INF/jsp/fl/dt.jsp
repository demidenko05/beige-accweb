...
<div class="input-line">
  ...
  <input id="${parVl1}" type="date" ${dsbl} required name="${parVl1}" value="${hldUvd.fltMp[parVl1]}" onchange="bsInpChn(this);">
  ...
  <input id="${parVl2}" type="date" ${dsbl} required name="${parVl2}" value="${hldUvd.fltMp[parVl2]}" onchange="bsInpChn(this);">
</div>
