...
<c:set var="valGteq50" value="TOPA/${invNm}.TOT gte 0.50"/>
...
<c:set var="valGteq100" value="TOPA/${invNm}.TOT gte 1"/>
...
<c:set var="valLt30" value="TOPA/${invNm}.TOT lt 0.30"/>
...
<c:set var="valLt50" value="TOPA/${invNm}.TOT lt 0.50"/>
...
<c:set var="valLt100" value="TOPA/${invNm}.TOT lt 1"/>
