...
<dialog id="frmRepDlg" class="dlg" oncancel="return false;">
  <div class="form-std">
    ...
    <form id="frmRepFrm" action="flr" method="GET" target="_blank">
      ...
      <table class="tbl-fieldset">
        <tr>
          <td>
            <label for="dt">${i18n.getMsg("date", rvs.upf.lng.iid)}:</label>
          </td>
        </tr>
        <tr>
          <td>
      ...
      <div class="form-actions">
        <button type="button" onclick="this.form.action='flr';document.getElementById('prcNm').value='PrcBlnSht';bsSbFrmNw('frmRepFrm', false);">${i18n.getMsg("ReportPdf", rvs.upf.lng.iid)}</button>
