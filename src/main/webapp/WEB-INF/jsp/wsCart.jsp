        ...
        <div class="modal-body">
          <form action="${urlPrf}?" method="POST">
            ...
            <c:if test="${empty buyr.registeredPassword}">
              ...
              <div class="row">
                <div class="col-12 col-md-4 mb-3">
                  <label>${i18n.getMsg("itsEmail", rvs.upf.lng.iid)}</label>
                </div>
                <div class="col-12 col-md-8 mb-3">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="${urlPrf}?" method="POST">
          ...
          <div class="row">
            <div class="col-12 col-md-4 mb-3">
              <label>${i18n.getMsg("item", rvs.upf.lng.iid)}</label>
            </div>
            <div class="col-12 col-md-8 mb-3">
          ...
          <div class="row">
            <div class="col-12 col-md-4 mb-3">
              <label>${i18n.getMsg("itsPrice", rvs.upf.lng.iid)}</label>
            </div>
            <div class="col-12 col-md-8 mb-3">
          ...
          <div class="row">
            <div class="col-12 col-md-4 mb-3">
              <label>${i18n.getMsg("unitOfMeasure", rvs.upf.lng.iid)}</label>
            </div>
            <div class="col-12 col-md-8 mb-3">
          ...
          <div class="row">
            <div class="col-12 col-md-3 mb-3">
              <label>${i18n.getMsg("itsQuantity", rvs.upf.lng.iid)}</label>
            </div>
          ...
          <div class="row">
            <div class="col-12 col-md-4 mb-3">
              <label>${i18n.getMsg("itsTotal", rvs.upf.lng.iid)} (${rvs.wscurr.sgn})</label>
            </div>
            <div class="col-12 col-md-8 mb-3">
      ...
      <div class="modal-body">
        <form action="${urlPrf}?" method="POST">
          ...
          <div class="form-group">
            ...
            <label>${i18n.getMsg("itsTotal", rvs.upf.lng.iid)}:</label>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <c:forEach var="cartLn" items="${cart.items}">
          <c:if test="${!cartLn.disab}">
            <div class="row">
              <div class="col-4">
                <b>${i18n.getMsg("item", rvs.upf.lng.iid)}:</b>
              </div>
              <div class="col-8">
                <b>${cartLn.nme}</b>
              </div>
            ...
            <div class="row">
              <div class="col-4">
                ${i18n.getMsg("itsPrice", rvs.upf.lng.iid)}:
              </div>
              <div class="col-8">
            ...
            <div class="row">
              <c:if test="${cartLn.forc}">
                <div class="col-6">
                  ${i18n.getMsg("itsQuantity", rvs.upf.lng.iid)}:
                </div>
                <div class="col-6">
                  ${utlJsp.prnNumberNtz(cartLn.quan.toString(), rvs.decSepv, rvs.decGrSepv, rvs.digInGr)}
                </div>
              </c:if>
              <c:if test="${!cartLn.forc}">
                <div class="col-4">
            ...
            <div class="row">
              <div class="col-4">
                ${i18n.getMsg("itsTotal", rvs.upf.lng.iid)}:
              </div>
              <div class="col-8">
        ...
        <c:if test="${cart.totTx.doubleValue() gt 0}">
          <div class="row">
            ...
            <div class="col-6">
              <b>${numStr.frmt(cart.totTx.toString(),rvs.cpf.dcSpv,rvs.cpf.dcGrSpv,rvs.astg.prDp,rvs.upf.dgInGr} ${rvs.wscurr.sgn}</b>
            </div>
          </div>
        </c:if>
        <div class="row">
          <div class="col-6">
            ${i18n.getMsg("itsTotal", rvs.upf.lng.iid)}
            <c:if test="${cart.totTx.doubleValue() gt 0 && tradSet.txExcl}">(${i18n.getMsg("txExcl", rvs.upf.lng.iid)})</c:if>
            <c:if test="${cart.totTx.doubleValue() gt 0 && !tradSet.txExcl}">(${i18n.getMsg("txIncl", rvs.upf.lng.iid)})</c:if>:
          </div>
          <div class="col-6">
            <b>${numStr.frmt(cart.tot.toString(),rvs.cpf.dcSpv,rvs.cpf.dcGrSpv,rvs.astg.prDp,rvs.upf.dgInGr}${rvs.wscurr.sgn}</b>
          </div>
        </div>
        <c:if test="${cart.totTx.doubleValue() gt 0 && rvs.shTxDet}">
      ...
      <div class="modal-footer">
        ...
        <c:if test="${!isUnSign && param.nmPrc ne 'PrcCheckOut'}">
          <a href="${urlPrf}?nmRnd=wchou&nmPrc=PrcCheckOut&nmRndRed=${nmRndRed}&nmPrcRed=${nmPrcRed}" type="button" class="btn btn-primary">${i18n.getMsg("check_out", rvs.upf.lng.iid)}</a>
        </c:if>
      </div>
    </div>
  </div>
